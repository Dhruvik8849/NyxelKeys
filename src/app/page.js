      ...
      <div className="px-8 py-12 lg:py-32 flex items-center justify-center flex-col gap-6 lg:gap-8">
        <div className="flex items-center justify-center flex-col gap-2">
          <h1 className="font-extrabold text-4xl lg:text-6xl tracking-tight">
            Learn the{' '}
            <span className="relative highlight-box text-accent-foreground">Nyxelkeys</span>
          </h1>
        ...
        <div className="py-24 px-8 max-w-7xl mx-auto flex gap-12 flex-col lg:flex-row">
          ...
          <Accordion type="single" collapsible className="basis-1/2 [&_a]:text-blue-800 [&_a:hover]:text-blue-600">
            ...
            <AccordionItem value="item-1">
                <AccordionTrigger className="text-lg lg:text-xl">Why Nyxelkeys?</AccordionTrigger>
              <AccordionContent>
                  The vision behind Nyxelkeys is to bring all software shortcuts into one place — so you never have to search multiple sites or dig through help menus again.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="item-2">
              <AccordionTrigger className="text-lg lg:text-xl">Is Nyxelkeys free to use?</AccordionTrigger>
              <AccordionContent>
                <p className="mb-2">Yes, Nyxelkeys is completely free and open source — no subscriptions, no ads, no sign-ups. If you love it and want to support development, you can buy me a coffee here -</p>
